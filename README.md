# README.md Generator
  ...
  ## Installation: 
  To install this project, you must clone my repository and open the files in VS Code. Then right click on the index.js file and select "Open integrated terminal". 
